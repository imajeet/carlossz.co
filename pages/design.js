			...
			<article id="designRepositories">
				...
				{this.state.repos.map(repo => (
					<div key={repo.id} className="repo">
						...
						<img src={repo.covers[230]}  />
						<div className="footer">
							{repo.fields.map(field => <span>{field}</span>)}

							<div className="img">
								<a href={repo.url} target="_blank"><img src="/static/behance.svg" /></a>
							</div>
						</div>
				...
				<style jsx>{`
					...
					.repo:hover img { filter: grayscale(0); }
					.repo .footer {
						text-align: center;
						position: absolute;
						bottom: 0;
